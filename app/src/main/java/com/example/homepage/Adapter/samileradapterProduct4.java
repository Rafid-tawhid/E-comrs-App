...
public class samileradapterProduct4 extends RecyclerView.Adapter<samileradapterProduct4.PhoneViewHold>  {

    ArrayList<samilerproductHelperClass> phoneLaocations;
    final private ListItemClickListener mOnClickListener;

    public samileradapterProduct4(ArrayList<samilerproductHelperClass> phoneLaocations, ListItemClickListener listener) {
    ...
    public PhoneViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fourthsamilerrecycview, parent, false);
    ...
    public void onBindViewHolder(@NonNull PhoneViewHold holder, int position) {
        ...
        samilerproductHelperClass phonehelper = phoneLaocations.get(position);
